...
//     /// <remarks>
//     /// All public and protected members of <see cref="HashTable{TKey,TValue}"/> are thread-safe and may be used
//     /// concurrently from multiple threads.
//     /// </remarks>
//     [DebuggerTypeProxy(typeof(IDictionaryDebugView<,>))]
//     [DebuggerDisplay("Count = {Count}")]
//     public class HashTable<TKey, TValue> : IDictionary<TKey, TValue>, IDictionary, IReadOnlyDictionary<TKey, TValue> where TKey : notnull
//     {
...
//         /// <summary>
//         /// Initializes a new instance of the <see cref="HashTable{TKey,TValue}"/>
...
//         /// <see cref="HashTable{TKey,TValue}"/> concurrently, or -1 to indicate a default value.</param>
//         /// <param name="capacity">The initial number of elements that the <see cref="HashTable{TKey,TValue}"/> can contain.</param>
//         /// <exception cref="ArgumentOutOfRangeException"><paramref name="concurrencyLevel"/> is less than 1.</exception>
//         /// <exception cref="ArgumentOutOfRangeException"> <paramref name="capacity"/> is less than 0.</exception>
//         public HashTable(int concurrencyLevel, int capacity)
...
//         /// cref="IEnumerable{T}"/> whose elements are copied to the new <see cref="HashTable{TKey,TValue}"/>.</param>
...
//         public HashTable(IEnumerable<KeyValuePair<TKey, TValue>> collection)
...
//         /// </summary>
//         /// <param name="collection">The <see cref="IEnumerable{T}"/> whose elements are copied to the new <see cref="HashTable{TKey,TValue}"/>.</param>
//         /// <param name="comparer">The <see cref="IEqualityComparer{TKey}"/> implementation to use when comparing keys.</param>
//         /// <exception cref="ArgumentNullException"><paramref name="collection"/> is a null reference (Nothing in Visual Basic).</exception>
//         public HashTable(IEnumerable<KeyValuePair<TKey, TValue>> collection, IEqualityComparer<TKey> comparer)
...
//         /// The estimated number of threads that will update the <see cref="HashTable{TKey,TValue}"/> concurrently, or -1 to indicate a default value.
//         /// </param>
//         /// <param name="collection">The <see cref="IEnumerable{T}"/> whose elements are copied to the new
//         /// <see cref="HashTable{TKey,TValue}"/>.</param>
//         /// <param name="comparer">The <see cref="IEqualityComparer{TKey}"/> implementation to use when comparing keys.</param>
//         /// <exception cref="ArgumentNullException"><paramref name="collection"/> is a null reference (Nothing in Visual Basic).</exception>
//         /// <exception cref="ArgumentOutOfRangeException"><paramref name="concurrencyLevel"/> is less than 1.</exception>
//         /// <exception cref="ArgumentException"><paramref name="collection"/> contains one or more duplicate keys.</exception>
//         public HashTable(int concurrencyLevel, IEnumerable<KeyValuePair<TKey, TValue>> collection, IEqualityComparer<TKey> comparer)
...
//         /// </summary>
//         /// <param name="concurrencyLevel">The estimated number of threads that will update the <see cref="HashTable{TKey,TValue}"/> concurrently, or -1 to indicate a default value.</param>
//         /// <param name="capacity">The initial number of elements that the <see cref="HashTable{TKey,TValue}"/> can contain.</param>
//         /// <param name="comparer">The <see cref="IEqualityComparer{TKey}"/> implementation to use when comparing keys.</param>
...
//         public HashTable(int concurrencyLevel, int capacity, IEqualityComparer<TKey> comparer)
//             : this(concurrencyLevel, capacity, growLockArray: false, comparer)
//         {
//         }
 
//         internal HashTable(int concurrencyLevel, int capacity, bool growLockArray, IEqualityComparer<TKey> comparer)
//         {
//             if (concurrencyLevel <= 0)
//             {
//                 if (concurrencyLevel != -1)
//                 {
//                     throw new ArgumentOutOfRangeException();//nameof(concurrencyLevel), SR.HashTable_ConcurrencyLevelMustBePositiveOrNegativeOne);
//                 }
...
//         /// <summary>
//         /// Gets an instance of a type that may be used to perform operations on a <see cref="HashTable{TKey, TValue}"/>
...
//                 {
//                     throw new ArgumentException();//SR.HashTable_SourceContainsDuplicateKeys);
//                 }
//             }
...
//         /// <summary>
//         /// Attempts to add the specified key and value to the <see cref="HashTable{TKey, TValue}"/>.
//         /// </summary>
//         /// <param name="key">The key of the element to add.</param>
//         /// <param name="value">The value of the element to add. The value can be a null reference (Nothing
//         /// in Visual Basic) for reference types.</param>
//         /// <returns>
//         /// true if the key/value pair was added to the <see cref="HashTable{TKey, TValue}"/> successfully; otherwise, false.
//         /// </returns>
//         /// <exception cref="ArgumentNullException"><paramref name="key"/> is null reference (Nothing in Visual Basic).</exception>
//         /// <exception cref="OverflowException">The <see cref="HashTable{TKey, TValue}"/> contains too many elements.</exception>
...
//         /// <summary>
//         /// Determines whether the <see cref="HashTable{TKey, TValue}"/> contains the specified key.
//         /// </summary>
//         /// <param name="key">The key to locate in the <see cref="HashTable{TKey, TValue}"/>.</param>
//         /// <returns>true if the <see cref="HashTable{TKey, TValue}"/> contains an element with the specified key; otherwise, false.</returns>
//         /// <exception cref="ArgumentNullException"><paramref name="key"/> is a null reference (Nothing in Visual Basic).</exception>
//         public bool ContainsKey(TKey key) => TryGetValue(key, out _);
 
//         /// <summary>
//         /// Attempts to remove and return the value with the specified key from the <see cref="HashTable{TKey, TValue}"/>.
//         /// </summary>
//         /// <param name="key">The key of the element to remove and return.</param>
//         /// <param name="value">
//         /// When this method returns, <paramref name="value"/> contains the object removed from the
//         /// <see cref="HashTable{TKey,TValue}"/> or the default value of <typeparamref
...
//             if (item.Key is null)
//             {
//                 // ThrowHelper.ThrowArgumentNullException(nameof(item), SR.HashTable_ItemKeyIsNull);
//             }
...
//         /// <summary>
//         /// Attempts to get the value associated with the specified key from the <see cref="HashTable{TKey,TValue}"/>.
//         /// </summary>
//         /// <param name="key">The key of the value to get.</param>
//         /// <param name="value">
//         /// When this method returns, <paramref name="value"/> contains the object from
//         /// the <see cref="HashTable{TKey,TValue}"/> with the specified key or the default value of
//         /// <typeparamref name="TValue"/>, if the operation failed.
//         /// </param>
//         /// <returns>true if the key was found in the <see cref="HashTable{TKey,TValue}"/>; otherwise, false.</returns>
//         /// <exception cref="ArgumentNullException"><paramref name="key"/> is a null reference (Nothing in Visual Basic).</exception>
...
//                                 if (!typeof(TValue).IsValueType || HashTableTypeProps<TValue>.IsWriteAtomic)
//                                 {
...
//         /// <summary>
//         /// Removes all keys and values from the <see cref="HashTable{TKey,TValue}"/>.
//         /// </summary>
//         public void Clear()
//         {
//             int locksAcquired = 0;
...
//                 {
//                     throw new ArgumentException();//SR.HashTable_ArrayNotLargeEnough);
//                 }
...
//         /// <summary>
//         /// Copies the key and value pairs stored in the <see cref="HashTable{TKey,TValue}"/> to a
//         /// new array.
//         /// </summary>
//         /// <returns>A new array containing a snapshot of key and value pairs copied from the <see cref="HashTable{TKey,TValue}"/>.
//         /// </returns>
...
//         /// cref="HashTable{TKey,TValue}"/>.</summary>
//         /// <returns>An enumerator for the <see cref="HashTable{TKey,TValue}"/>.</returns>
//         /// <remarks>
...
//             private readonly HashTable<TKey, TValue> _dictionary;
 
//             private HashTable<TKey, TValue>.VolatileNode[] _buckets;
//             private Node _node;
//             private int _i;
//             private int _state;
...
//             public Enumerator(HashTable<TKey, TValue> dictionary)
//             {
...
//                     case StateOuterloop:
//                         HashTable<TKey, TValue>.VolatileNode[] buckets = _buckets;
...
//         /// <see cref="HashTable{TKey, TValue}" /> and to provide hash values for the keys.
//         /// </value>
//         /// <remarks>
//         /// <see cref="HashTable{TKey, TValue}" /> requires an equality implementation to determine
...
//         /// cref="HashTable{TKey,TValue}"/>.</value>
...
//         /// <summary>
//         /// Adds a key/value pair to the <see cref="HashTable{TKey,TValue}"/>
...
//         /// <summary>
//         /// Adds a key/value pair to the <see cref="HashTable{TKey,TValue}"/> if the key does not already
//         /// exist, or updates a key/value pair in the <see cref="HashTable{TKey,TValue}"/> if the key
//         /// already exists.
//         /// </summary>
...
//         /// <summary>
//         /// Gets a value that indicates whether the <see cref="HashTable{TKey,TValue}"/> is empty.
//         /// </summary>
//         /// <value>true if the <see cref="HashTable{TKey,TValue}"/> is empty; otherwise,
//         /// false.</value>
//         public bool IsEmpty
//         {
//             get
...
//         /// cref="HashTable{TKey,TValue}"/>.</exception>
//         void IDictionary<TKey, TValue>.Add(TKey key, TValue value)
//         {
//             if (!TryAdd(key, value))
//             {
//                 throw new ArgumentException();//SR.HashTable_KeyAlreadyExisted);
//             }
//         }
...
//         /// <summary>
//         /// Gets a snapshot containing all the keys in the <see cref="HashTable{TKey,TValue}"/>.
//         /// </summary>
//         /// <remarks>The property returns a copy of all the keys. It's not kept in sync with <see cref="HashTable{TKey,TValue}"/>.</remarks>
...
//         /// <summary>
//         /// Gets a snapshot containing all the values in the <see cref="HashTable{TKey,TValue}"/>.
//         /// </summary>
//         /// <remarks>The property returns a copy of all the values. It's not kept in sync with <see cref="HashTable{TKey,TValue}"/>.</remarks>
...
//         /// cref="HashTable{TKey,TValue}"/>.</param>
...
//         /// <see cref="HashTable{TKey,TValue}"/></exception>
...
//         /// cref="HashTable{TKey,TValue}"/>, this property always returns
//         /// false.</value>
...
//         /// made to the dictionary after <see cref="GetEnumerator"/> was called.
//         /// </remarks>
//         IEnumerator IEnumerable.GetEnumerator() => ((HashTable<TKey, TValue>)this).GetEnumerator();
...
//         /// name="TKey"/> of the <see cref="HashTable{TKey,TValue}"/>. -or-
//         /// <paramref name="value"/> is of a type that is not assignable to <typeparamref name="TValue"/>,
//         /// the type of values in the <see cref="HashTable{TKey,TValue}"/>.
...
//             if (!(key is TKey))
//             {
//                 throw new ArgumentException();//SR.HashTable_TypeOfKeyIncorrect);
//             }
...
//         /// cref="HashTable{TKey,TValue}"/>, this property always
//         /// returns false.</value>
...
//         /// cref="HashTable{TKey,TValue}"/>. -or- A value is being
...
//                 ((HashTable<TKey, TValue>)this)[(TKey)key] = (TValue)value!;
//             }
//         }
...
//                 throw new ArgumentException();//SR.HashTable_ArrayIncorrectType, nameof(array));
//             }
//             finally
//             {
//                 ReleaseLocks(locksAcquired);
...
//                         // calling Clear() on the HashTable will shrink the table and lower the budget.)
//                         _budget = int.MaxValue;
//                     }
//                 }
...
//             {
//                 CDSCollectionETWBCLProvider.Log.HashTable_AcquiringAllLocks(_tables._buckets.Length);
//             }
...
//         /// <summary>Tables that hold the internal state of the HashTable</summary>
...
//             internal DictionaryEnumerator(HashTable<TKey, TValue> dictionary) => _enumerator = dictionary.GetEnumerator();
...
//         [MethodImpl(MethodImplOptions.AggressiveInlining)]
//         private static bool IsCompatibleKey<TAlternateKey>(HashTable<TKey, TValue>.Tables tables)
...
//         [MethodImpl(MethodImplOptions.AggressiveInlining)]
//         private static IAlternateEqualityComparer<TAlternateKey, TKey> GetAlternateComparer<TAlternateKey>(HashTable<TKey, TValue>.Tables tables)
//              where TAlternateKey : notnull//, allows ref struct
//         {
...
//         /// <summary>
//         /// Provides a type that may be used to perform operations on a <see cref="HashTable{TKey, TValue}"/>
//         /// using a <typeparamref name="TAlternateKey"/> as a key instead of a <typeparamref name="TKey"/>.
//         /// </summary>
//         /// <typeparam name="TAlternateKey">The alternate type of a key for performing lookups.</typeparam>
...
//             internal AlternateLookup(HashTable<TKey, TValue> dictionary)
//             {
...
//             /// <summary>Gets the <see cref="HashTable{TKey, TValue}"/> against which this instance performs operations.</summary>
//             public HashTable<TKey, TValue> Dictionary { get; }
...
//             /// <summary>Determines whether the <see cref="HashTable{TKey, TValue}"/> contains the specified alternate key.</summary>
...
//     internal static class HashTableTypeProps<T>
//     {
